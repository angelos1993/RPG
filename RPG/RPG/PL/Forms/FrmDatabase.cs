    ...
    public partial class FrmDatabase : FrmMaster
    {
        ...
        private void BackupDatabase()
        {
            try
            {
                ...
                var backup = new Backup { Action = BackupActionType.Database, Database = Constants.DatabaseName };
                backup.Devices.AddDevice(
                    $@"{folderBrowserDialog.SelectedPath}\{Constants.DatabaseName} - {DateTime.Now.ToFormattedDate()}.bak",
                    DeviceType.File);
